...
public class WADialog{
	...
	public void keyShowDialog(){
		final JDialog key_dialog = new JDialog(new CompilePrinciple_App().getJframe(),"关键词"); 
	...
	public void separatorShowDialog(){
		final JDialog separator_dialog = new JDialog(new CompilePrinciple_App().getJframe(),"分隔符"); 
	...
	public void lookKeyDialog(){
		if(new WAEventHandler().getWAEvent().getKeyArr().isEmpty()){
			final JDialog key_dialog = new JDialog(new CompilePrinciple_App().getJframe(),"错误提示");
			key_dialog.setVisible(true);
			...
			final JDialog key_dialog = new JDialog(new CompilePrinciple_App().getJframe(),"关键字表");
			key_dialog.setVisible(true);
			key_dialog.setSize(400,500);
			key_dialog.setLocation(500,120);
			key_dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
	...
	public void lookSeparatorDialog(){
		if(new WAEventHandler().getWAEvent().getSeparatorArr().isEmpty()){
			...
			final JDialog separator_dialog = new JDialog(new CompilePrinciple_App().getJframe(),"分界符表");
			separator_dialog.setVisible(true);
			separator_dialog.setSize(400,500);
			separator_dialog.setLocation(500,120);
			separator_dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
			...
			String[][] arr_arithMetic_content = new WAArrayDistri().getStr(2, new WAEventHandler().getWAEvent().getSeparatorArr() , "算术运算符");
			...
			String[][] arr_relation_content = new WAArrayDistri().getStr(2, new WAEventHandler().getWAEvent().getSeparatorArr() , "关系运算符");
			...
			String[][] arr_logic_content = new WAArrayDistri().getStr(2, new WAEventHandler().getWAEvent().getSeparatorArr() , "逻辑运算符");
			...
			String[][] arr_bit_content = new WAArrayDistri().getStr(2, new WAEventHandler().getWAEvent().getSeparatorArr() , "位操作运算符");
			...
			String[][] arr_assign_content = new WAArrayDistri().getStr(2, new WAEventHandler().getWAEvent().getSeparatorArr() , "赋值运算符");
			...
			String[][] arr_condition_content = new WAArrayDistri().getStr(2, new WAEventHandler().getWAEvent().getSeparatorArr() , "条件运算符");
			...
			String[][] arr_boundary_content = new WAArrayDistri().getStr(2, new WAEventHandler().getWAEvent().getSeparatorArr() , "分隔符");
